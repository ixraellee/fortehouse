...
//   $dbconnect = mysqli_connect("localhost", "root", "", "registration") or die("Couldnt establish database connection !!!");
  $dbconnect = mysqli_connect("localhost", "forteho1_forteho1", "VC2uFi27a4)a*T", "forteho1_registration") or die("Couldnt establish database connection !!!");
  session_start();
          ...
          <div class="menu-and-user">
            ...
            <ul class="main-menu">             
              <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                  <li>
                    <a href="layouts_menu_side_full.html">Account Today</a>
                  </li>                  
                </ul>
              </li>
              <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                  <li>
                    <a href="apps_email.html">Make Deposits</a>
                  </li>
                  <li>
                    <a href="apps_support_dashboard.html">Local Transfers</a>
                  </li>
                  <li>
                    <a href="apps_support_index.html">International Transfers</a>
                  </li>                  
                </ul>
              </li>
              ...
              <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                  <li>
                    <a href="uikit_modals.html">Me2Me <strong class="badge badge-danger">New</strong></a>
                  </li>                  
                </ul>
              </li> 
              <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                  <li>
                    <a href="forms_regular.html">Change Password</a>
                  </li>                  
                </ul>
              </li>              
              <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                  <li>
                    <a href="icon_fonts_simple_line_icons.html"></a>
                  </li>                  
                </ul>
              </li>
            </ul>
              ...
              <div class="sub-menu-w">
                ...
                <div class="sub-menu-i">
				  ...
				  <li>
                    ...
                    <li>
                      <a href="index.html">Local Transfer</a>
                    </li>
					<li>
                      <a href="index.html">International Transfer</a>
                    </li>
                    <!--li>
            ...
            <li class=" has-sub-menu">
              ...
              <div class="sub-menu-w">
                ...
                <div class="sub-menu-i">
                  <ul class="sub-menu">
                    <li>
                      <a href="layouts_menu_side_full.html">Local Transfer </a>
                    </li>
                    <li>
                      <a href="layouts_menu_side_full_dark.html">International Transfer </a>
                    </li>
                    <li>
                      <a href="layouts_menu_side_transparent.html">Deposits </a>
                    </li>                    
                    <li>
                      <a href="#">Me 2 Me</a>
                    </li>
            ...
            <li class=" has-sub-menu">
              ...
              <div class="sub-menu-w">
                ...
                <div class="sub-menu-i">
                  <ul class="sub-menu">
                    <li>
                      <a href="#">Tip of the Day</a>
                    </li>
                    <li>
                      <a href="#">Long shots <strong class="badge badge-danger">New</strong></a>
                    </li>
                    <!--li>
