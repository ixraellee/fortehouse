<?php 
  ...
  $dbconnect = mysqli_connect("localhost", "root", "", "forteho1_registration");
  session_start();
            ...
            <div class="content-box">
              <div class="element-wrapper compact pt-4">
                <div class="element-actions">
                  <a class="btn btn-primary btn-sm" href="apps_bank_transfer.php"><i class="os-icon os-icon-ui-22"></i><span>Deposit</span></a><a class="btn btn-primary btn-sm" href="transfer.php"><i class="os-icon os-icon-grid-10"></i><span>Local Transfer</span></a><a class="btn btn-success btn-sm" href="transfer.php"><i class="os-icon os-icon-grid-10"></i><span>International Transfer</span></a>
                </div>
                  ...
                  <div class="element-wrapper">
                    <div class="element-box">
                      ...
                      <div class="el-chart-w">
                        <canvas data-chart-data="13,28,19,24,43,49,40,35,42,46" height="190" id="liteLineChartV2" width="300"></canvas>
                      </div>
                    </div>
                  </div>
                  <!--END - CHART-->
                    ...
                    <div class="element-box">
                      <form>
                        ...
                        <div class="row">
						  ...
						  <div class="col-sm-12">
                            <div class="form-group">								
                              <label class="lighter" for="">Bank Name</label><input class="form-control" data-error="Enter Correct Account Info" placeholder="Enter Bank Name" required="required" type="text">                                
                            </div>
                          </div>
						  <div class="col-sm-12">
						  <div class="form-group">
							  <label class="lighter" for="">Bank Address</label><textarea class="form-control" rows="2" placeholder="Enter Bank Address" required="required"></textarea>
							</div>
                          </div>
                          <div class="col-sm-12">
                            <div class="form-group">								
                              <label class="lighter" for="">Country</label><input class="form-control" data-error="Enter Correct Account Info" placeholder="Enter Bank Country" required="required" type="text">                                
                            </div>
                          </div>
						  <div class="col-sm-12">
                            <div class="form-group">								
                              <label class="lighter" for="">Account Name</label><input class="form-control" data-error="Enter Correct Account Info" placeholder="Account Name" required="required" type="text">                                
                            </div>
                          </div>
						  <div class="col-sm-12">
                            <div class="form-group">								
                              <label class="lighter" for="">Account Number</label><input class="form-control" data-error="Enter Correct Account Info" placeholder="Enter Account Number" required="required" type="text">                                
                            </div>
                          </div>
						  <div class="col-sm-12">
                            <div class="form-group">								
                              <label class="lighter" for="">Sort Code/Routing Number</label><input class="form-control" data-error="Enter Correct Account Info" placeholder="Enter Sort Code/Routing Number" required="required" type="text">                                
                            </div>
                          </div>
                        </div>
