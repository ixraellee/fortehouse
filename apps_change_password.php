 ...
 if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (
        ...
        ) 
        {
            ...
            $last_name = $_POST['confirm_password'];
            ...
            // user has successfully passed validation'
                ...
                if ($first_name !== $last_name) {
                    ...
                    $user_id = $_SESSION['user_id'];
                   $hashpass = password_hash($first_name, PASSWORD_DEFAULT);
                    $sql = "UPDATE users SET `hashed_password`='$hashpass' WHERE `nickname`='$user_id'";
          ...
          <div class="content-i">
            <div class="content-box">
              ...
              <div class="row">				
                ...
                <?php 
                    if ($res) { ?>
                        <div class="alert alert-success text-white">Password has been updated successfully</div>
                    <?php }
                ?>
                      ...
                      <form id="transfer-form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">								
                              <label class="lighter" for="">Password</label><input class="form-control" data-error="Enter Correct Account Info" placeholder="Enter new password" required type="text" id="bank_name" name="password" value="">                                
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">								
                              <label class="lighter" for="">Confirm Password</label><input class="form-control" data-error="Enter Correct Account Info" placeholder="Retype Password" required type="text" id="bank_name" name="confirm_password" value="">                                
                            </div>
                        </div>

                        
						<button class="mr-2 mb-2 btn btn-primary" id="transfer-btn"  type="submit">Update Password<span></span><i class="os-icon os-icon-grid-18"></i></button>
							<!--div class="form-group">
