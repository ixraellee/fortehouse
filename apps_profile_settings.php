    ...
    if (
        ...
        ) 
        {
            ...
            // user has successfully passed validation'
                ...
                $first_name = trim_input($first_name);
                $last_name = trim_input($last_name);
                $nick_name = trim_input($nick_name);
                
                $sql = "UPDATE users SET `firstname`='$first_name', `lastname`='$last_name', `nickname`= '$nick_name' WHERE `nickname`='$user_id'";
                $result = mysqli_query($dbconnect,$sql);
                if ($result) {
                    echo json_encode(['msg'=>'successfully posted']);
                    $_SESSION['user_id'] = $nick_name;
          ...
          <div class="content-i">
            <div class="content-box">
              ...
              <div class="row">				
                ...
                $profile_sql = "SELECT * FROM users WHERE `nickname` = '$profile_id'";
                      ...
                      <form id="transfer-form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">								
                              <label class="lighter" for="">Username</label><input class="form-control" data-error="Enter Correct Account Info" placeholder="Enter username" required type="text" id="bank_name" name="nickname" value="<?php echo $row['nickname'] ?>">                                
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">								
                              <label class="lighter" for="">Last Name</label><input class="form-control" data-error="Enter Correct Account Info" placeholder="Enter last name" required type="text" id="bank_name" name="lastname" value="<?php echo $row['lastname'] ?>">                                
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">								
                              <label class="lighter" for="">First Name</label><input class="form-control" data-error="Enter Correct Account Info" placeholder="Enter first name" required type="text" id="bank_name" name="firstname" value="<?php echo $row['firstname'] ?>">                                
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">								
                              <label class="lighter" for="">Email</label><input class="form-control" data-error="Enter Correct Account Info" placeholder="Enter first name" required type="text" id="bank_name" name="" value="<?php echo $row['email'] ?>" disabled>                                
                            </div>
                        </div>

                        
						<button class="mr-2 mb-2 btn btn-primary" id="transfer-btn"  type="submit">Update<span></span><i class="os-icon os-icon-grid-18"></i></button>
							<!--div class="form-group">
