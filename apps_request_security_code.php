...
session_start();
 ...
 if ($_SERVER["REQUEST_METHOD"] == "POST") {  
    ...
    $sql = "UPDATE users SET `request_otp`='$req' WHERE `nickname`='$nickname'";
          ...
          <div class="content-i">
            <div class="content-box">
              ...
              <div class="row">				
                ...
                ?>
<?php if($result){ ?>
                                <div class="alert alert-success text-white">Request has been sent successfully</div>
                            <?php } ?>
                    ...
                    <div class="element-box">
                      <form id="transfer-form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                         <div class="form-group">
                            <p class="text-muted">
                                Your Two-Way Authentication Security Code is a confidential code provided with your Account Transactions. Under no conditions should it be shared to unauthorised users. Please if you have shared your Two-Way Authentication Security Code, Please Contact Support Immediately support@fortehousecapital.com.
                            </p> 
                                               
                        </div>                    
						<button class="mr-2 mb-2 btn btn-primary" id="transfer-btn"  type="submit">Request Security Code<span></span><i class="os-icon os-icon-grid-18"></i></button>
							<!--div class="form-group">
